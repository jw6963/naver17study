    ...
    <form action="./insert" method="post" enctype="multipart/form-data">
        <table class="tab1 table table-boredered">
            ...
            <tr>
                <th>수량</th>
                <td>
                    <input type="number" name="scnt" value="1" required="required" class="form-control">
                </td>
            </tr>
            <tr>
                <th>색상</th>
                <td>
                    <input type="color" name="scolor" value="#ddccff" class="form-control">
                </td>
            </tr>
            <tr>
                <th>입고일</th>
            ...
            <tr>
                <td colspan="2" align="center">
                    <button type="submit" class="btn btn-sm btn-success">상품 등록</button>
                    <button type="button" class="btn btn-sm btn-success"
                    onclick="location.href='./list'">상품 목록</button>
                </td>
            </tr>
        </table>
    </form>
