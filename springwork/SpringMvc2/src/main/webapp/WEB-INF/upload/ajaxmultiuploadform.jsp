...
<body>
<h4 class="alert alert-danger">Ajax로 여러 사진 업로드 하기</h4>
<input type="file" id="photoupload" multiple>
<hr>
<div class="photos container" style="margin: 20px;"></div>
<script>
        ...
        $.ajax({
            ...
            success:(function (res) {
                ...
                $.each(res,function (idx,ele) {
                    s+=`<img src="./save/\${ele.photo}" style="max-width: 300px; margin: 5px;">`;
                })
                $(".photos").html(s);
            })
        })
