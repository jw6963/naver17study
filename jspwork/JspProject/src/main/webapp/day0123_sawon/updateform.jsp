		...
		<table class="tab table table-bordered" style="width: 400px;">
			...
			<tr>
				...
				int curYear = new Date().getYear()+1900;%>
					<input type="number" name="sbirth" max="<%=curYear %>" class="form-control" value="<%=dto.getSbirth()%>">
				</td>
			</tr>
			<tr>
				<th width="100">혈액형</th>
				<td>
					...
					for(String b:blood){%>
						<label>
							<input type="radio" value="<%=b%>" name="sblood" <%=b.equals(dto.getSblood())?"checked":"" %>><%=b %>형
						</label>
						&nbsp;
			...
			<tr>
				<td colspan="2" align="center">
					<button type="submit" class="btn btn-success btn-sm">정보 수정</button>
