		...
		<form action="./insert" method="post">
			<table class="table table-bordered">
				...
				<tr>
					...
					</select> <br> <img src="" class="shopphoto" width="100"> 
				...
				<tr>
					...
					<td><input type="number" name="scnt" id="scnt"
						class="form-control" min="1" max="10" value="1"></td>
				</tr>
				<tr>
					<td style="background-color: lightgray;">입고일</td>
					<td><input type="data" name="ipgoday" id="ipgoday"
						class="form-control" value="2025-01-01"></td>
				</tr>
				<tr>
					<td colspan="2" align="center">
						<button type="submit" data-bs-dismiss="modal"
							style="width: 120px;">등록하기</button>
					</td>
				</tr>
			</table>
		</form>
