...
<%
	...
	String []colors={"green","red","pink","orange","tomato","blue"};
...
<body>
<h3 class="alert alert-danger">JSTL-for문</h3>
<c:forEach var="mycolor" items="${colors }" varStatus="i" begin="0" end="5">
