...
public class Ex5String {
	...
	public static void main(String[] args) {
		...
		System.out.println("str2에서 a의 위치는 :"+str2.indexOf('a')); // 1 : 첫번재 a의 위치
		...
		System.out.println(n); // 문자열1이 문자열 2보다 작을 경우 마이너스 값 -1:'A하고 'B'하고 비교
		
		n=str3.compareTo(str1); // Orange, Apple을 비교 'O', 'A'
		...
		System.out.println();
		System.out.println("str2가 Have로 시작하면 true: "+str2.startsWith("Have")); // ture
		...
		System.out.println("str2가 Day! 로 끝나면 true: "+str2.endsWith("Day1!")); // false
		...
		System.out.println();
		System.out.println(str2.substring(7)); // 7번인덱스부터 끝까지 추출
		System.out.println(str2.substring(7, 11)); // 7~11까지 추출
