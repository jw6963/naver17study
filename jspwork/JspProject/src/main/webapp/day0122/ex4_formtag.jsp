...
<div style="margin: 30px;">
		<form action="./ex4_action.jsp" method="post">
			<table class="table table-bordered" style="width: 300px">
				<tr>
					<th width="100">아이디</th>
					<td><input type="text" name="myid" class="form-control" required="required" value="angel"></td>
				</tr>
				<tr>
					<th width="100">비밀번호</th>
					<td><input type="password" name="mypass" class="form-control" required="required" value="12345"></td>
				</tr>
				<tr>
					<th width="100">이름</th>
					<td><input type="text" name="myname" class="form-control" required="required" value="김영구"></td>
				</tr>
				<tr>
					<th width="100">운전면허</th>
					<td>
					<label>
					<!-- checkbox: value가 없을 경우 체크 시 "on", 체크 안 하면 null 
					value 지정 시 체크할 경우 "value값" -->
				...
				<tr>
					...
					<!-- type이 image인 경우도 submit에 해당됨 -->
					<input type="image" value="서버에 전송" src="../image/mycar/mycar12.png" style="width:100px">
					</td>
				</tr>
			</table>
		</form>
